...
enum RadarSharedConstants {
    ...
    static let baseURL = "https://radar2.meteorabbit.io/%@/radar_%@_%@_overlay%@.png"
    static let forecastBaseURL = "https://radar2.meteorabbit.io/forecast/%@/radar_%@_%@_fct%d_overlay%@.png"
